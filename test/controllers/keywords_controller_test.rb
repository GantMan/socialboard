...
class KeywordsControllerTest < ActionController::TestCase
  ...
  test "should create keyword" do
    assert_difference('Keyword.count') do
      post :create, keyword: { blacklist: @keyword.blacklist, board_id: @keyword.board_id, text: @keyword.text }
    end
  ...
  test "should update keyword" do
    patch :update, id: @keyword, keyword: { blacklist: @keyword.blacklist, board_id: @keyword.board_id, text: @keyword.text }
    assert_redirected_to keyword_path(assigns(:keyword))
  end
